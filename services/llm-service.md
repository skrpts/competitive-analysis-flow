...
id: llm-service
title: LLM Service
description: "Language model service providing competitive research and market analysis capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for competitive research and market analysis. Used by all skills in this skrpt.
